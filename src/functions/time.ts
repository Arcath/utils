...
export const msAsMinutes = chain(divideBy(SECOND_IN_MS), divideBy(MINUTE_IN_SECONDS))
export const msAsHour = chain(divideBy(SECOND_IN_MS), divideBy(MINUTE_IN_SECONDS), divideBy(HOUR_IN_MINUTES))

export const secondsInMs = multiplyBy(SECOND_IN_MS)
export const secondsAsMinutes = divideBy(MINUTE_IN_SECONDS)
export const secondsAsHours = chain(divideBy(MINUTE_IN_SECONDS), divideBy(HOUR_IN_MINUTES))
...
export const hoursInMs = chain(multiplyBy(HOUR_IN_MINUTES), multiplyBy(MINUTE_IN_SECONDS), multiplyBy(SECOND_IN_MS))
export const hoursInSeconds = chain(multiplyBy(HOUR_IN_MINUTES), multiplyBy(MINUTE_IN_SECONDS))
